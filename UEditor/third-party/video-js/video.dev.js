...
vjs.options = {
  ...
  // Default userMessage to show when a video cannot be played.
...
vjs.Player.prototype.exitFullWindow = function(){
  ...
  // Resize the box, controller, and service to original sizes
  // this.positionAll();
...
/**
 * the url of the service images source
 * @type {String}
 * @private
 */
...
/**
 * get or set the service images source url
 *
 * ##### EXAMPLE:
 *
 *     // getting
 *     var currentPoster = myPlayer.service();
 *
 *     // setting
 *     myPlayer.service('http://example.com/myImage.jpg');
 *
 * @param  {String=} [src] Poster images source URL
 * @return {String} service URL when getting
 * @return {vjs.Player} self when setting
 */
...
================================================================================ */
/**
 * The component that handles showing the service images.
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.PosterImage.prototype.createEl = function(){
  var el = vjs.createEl('div', {
        className: 'vjs-service',

        // Don't want service to be tabbable.
        tabIndex: -1
      }),
...
vjs.Html5 = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // In Chrome (15), if you have autoplay + a service + no controls, the video gets hidden (but audio plays)

        ...
        <div class="contain">
            <div class="tab">
                <el-tabs type="border-card"  v-model="activeName">
                    <el-tab-pane label="智能设备维修" name="smartDevice" style='background-color:white'>
                        <div class="top">
                            <div class="top-form">
...
<!--                                <el-button type="success" @click="add" class="postButton" icon="el-icon-plus">通知维修</el-button>-->
        ...
        <smart-dialog ref="smartDialog"></smart-dialog>
    ...
    export default {
        ...
        methods:{
            ...
            add(){
                ...
                this.$refs.userDialog.accentType = 'smart'
            },
            ...
            // 处理
            handle(row,index){
                this.$refs.smartDialog.dialogFormVisible = true;
                this.$refs.smartDialog.init(row);
            },
            // 重置
            reset(){
                this.form={

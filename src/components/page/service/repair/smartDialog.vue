<template>
    <el-dialog title="智能处理" :visible.sync="dialogFormVisible" class="detail-dialog">
        <el-form ref="form"
                 :model="formData"
                 label-width="100px"
                 class="box_acct_form">
...
<!--                </el-col>-->
            ...
            <el-row :gutter="24">
                <el-col :span="12" style="width: 100%">
                    <el-button v-show="this.type == '1'" type="primary" size="medium" style="margin-left: 520px;text-align: center;width: 100px" @click="handleSubmit">处理提交</el-button>
                    ...
                    success: (result)=>{
                        ...
                        this.$axiosToken({
                            ...
                            data:{
                                ...
                                smartstatus: this.formData.resultstatus
                            },
                            success: (result) =>{
                            }
                        })
